...
?>
    <tr>
    <td align="center">
    <span><?php echo $this->_var['list']['scene']; ?> </span></td>
    <td align="center"><span><?php echo $this->_var['list']['money']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['scan_count']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['endtime']; ?></span></td>
    <td align="center"><?php echo $this->_var['list']['function']; ?></td>
    <td align="center" nowrap="true"><span>
      <a href="<?php echo $this->_var['list']['qr_path']; ?>" target="_blank" title="查看"><img src="images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="wxch_tuijian.php?act=edit<?php if ($this->_var['list']['type_name'] == QR_SCENE): ?>&type=scent<?php else: ?>&type=limit<?php endif; ?>&id=<?php echo $this->_var['list']['qid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['qid']; ?>, '您确认要删除吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
    </td>
   </tr>
