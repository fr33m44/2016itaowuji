...
<?php echo $this->smarty_insert_scripts(array('files'=>'../data/static/js/utils.js,../data/static/js/region.js')); ?>
<div class="tab-div">
  <!-- tab bar -->
  <div id="tabbar-div">
    <p>
...
<?php echo $this->smarty_insert_scripts(array('files'=>'./js/tab.js,./js/validator.js')); ?>
