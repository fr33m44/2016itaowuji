...
$_LANG['cart_info'] = "进货单<span>（<strong>%d</strong>）</span>";
...
$_LANG['collect'] = '加入收藏夹';
$_LANG['add_to_cart'] = "加入进货单";
$_LANG['return_to_cart'] = "放回进货单";
...
$_LANG['shop_prices'] = "购买价";
$_LANG['market_prices'] = "吊牌价";
$_LANG['deposit'] = '团购保证金';
$_LANG['amount'] = '商品总价';
$_LANG['number'] = '购买数量';
$_LANG['handle'] = '操作';
...
$_LANG['goods_exists'] = "对不起，您的进货单中已经存在相同的商品。";
$_LANG['fitting_goods_exists'] = "对不起，您的进货单中已经添加了该配件。";
$_LANG['invalid_number'] = '对不起，您输入了一个非法的商品数量。';
$_LANG['not_on_sale'] = '对不起，该商品已经下架。';
$_LANG['no_basic_goods'] = "对不起，您希望将该商品做为配件购买，可是进货单中还没有该商品的基本件。";
$_LANG['cannt_alone_sale'] = '对不起，该商品不能单独销售。';
$_LANG['shortage'] = "进货数量超过库存量，最多可以购买%d件";
$_LANG['shortage_little'] = "该商品已经库存不足。已将您的购货数量修改为 %d。\n您现在要去进货单吗？";
$_LANG['oos_tips'] = '该商品已经库存不足。您现在要进行缺货登记吗？';

$_LANG['addto_cart_success_1'] = "该商品已添加到进货单，您现在还需要继续购物吗？\n如果您希望马上结算，请点击“确定”按钮。\n如果您希望继续购物，请点击“取消”按钮。";
$_LANG['addto_cart_success_2'] = "该商品已添加到进货单，您现在还需要继续购物吗？\n如果您希望继续购物，请点击“确定”按钮。\n如果您希望马上结算，请点击“取消”按钮。";
...
$_LANG['ws_goods_attr_exists'] = "该商品已经在进货单中，不能再次加入";
...
$_LANG['please_select_attr'] = "你加入进货单的商品有不同型号可选，你是否要立即跳转到商品详情选择型号？";
...
$_LANG['wholesale_goods_cart'] = "批发商品进货单";
