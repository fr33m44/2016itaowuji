...
$_LANG['label_user_type'] = '会员类型';
$_LANG['label_storestype'] = '店铺类型';
$_LANG['all_option'] = '所有等级';
$_LANG['all_optiontype'] = '所有类型';
$_LANG['pls_select_user'] = '当前页暂无可打印会员信息';

$_LANG['view_order'] = '查看订单';
$_LANG['view_deposit'] = '查看账目明细';
$_LANG['username'] = '会员名称';
$_LANG['user_type'] = '用户类型';
$_LANG['mobile_phones'] = '手机号码';
