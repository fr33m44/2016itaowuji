...
/* 购物车 */
$_LANG['update_cart'] = "更新进货单";
$_LANG['back_to_cart'] = "返回进货单";
$_LANG['update_cart_notice'] = "进货单更新成功，请您重新选择您需要的赠品。";
$_LANG['direct_shopping'] = '不打算登录，直接购买';
$_LANG['goods_not_exists'] = "对不起，指定的商品不存在";
$_LANG['drop_goods_confirm'] = "您确实要把该商品移出进货单吗？";
...
$_LANG['no_goods_in_cart'] = "您的进货单中没有商品！";
...
$_LANG['no'] = '无';
$_LANG['not_support_virtual_goods'] = "进货单中存在非实体商品,不支持匿名购买,请登陆后在购买";
$_LANG['not_support_insure'] = '不支持保价';
$_LANG['clear_cart'] = "清空进货单";
$_LANG['drop_to_collect'] = '放入收藏夹';
$_LANG['password_js']['show_div_text'] = "请点击更新进货单按钮";
...
$_LANG['favourable_not_exist'] = "您要加入进货单的优惠活动不存在";
$_LANG['favourable_not_available'] = '您不能享受该优惠';
$_LANG['favourable_used'] = "该优惠活动已加入进货单了";
$_LANG['pls_select_gift'] = '请选择赠品（特惠品）';
$_LANG['gift_count_exceed'] = '您选择的赠品（特惠品）数量超过上限了';
$_LANG['gift_in_cart'] = "您选择的赠品（特惠品）已经在进货单中了：%s";
...
$_LANG['gift_remainder'] = "说明：在您登录或注册后，请到进货单页面重新选择赠品。";
