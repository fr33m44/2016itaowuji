<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:62:"D:/wwwroot/itaowuji/wwwroot/mobile/themes/miqinew/category.dwt";i:1;s:79:"D:/wwwroot/itaowuji/wwwroot/mobile/themes/miqinew/library/goods_list_search.lbi";i:2;s:67:"D:/wwwroot/itaowuji/wwwroot/mobile/themes/miqinew/library/pages.lbi";i:3;s:73:"D:/wwwroot/itaowuji/wwwroot/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1472060152;s:8:"maketime";i:1472056552;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>面部护理_化妆品专柜_淘五季 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=155&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=155&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=155&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=155&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=155&page=1">1</option>
                                    </select>
          </div>
  ...
  <p class="link region"> <a href="http://www.itaowuji.com/?computer=1"> 电脑版 </a> <a href="./"> 触屏版 </a> <a href="#"> 苹果客户端 </a> <a class="#"> Android客户端 </a> </p>
  <p class="region"> 
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=155&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
