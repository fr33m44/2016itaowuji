...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <?php endif; ?>
	<th><a href="javascript:listTable.sort('sales_volume_base'); ">销量基数</a><?php echo $this->_var['sort_sales_volume_base']; ?></th>
...
?>
  <tr>
    ...
    <?php endif; ?>
	<td align="center"><span onclick="listTable.edit(this, 'edit_sales_volume_base', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['sales_volume_base']; ?></span></td>
    <td align="center">
