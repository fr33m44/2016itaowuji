...
<script type="text/javascript" src="../data/static/js/calendar.php"></script>
...
<?php echo $this->smarty_insert_scripts(array('files'=>'../data/static/js/transport.js,../data/static/js/region.js')); ?>
