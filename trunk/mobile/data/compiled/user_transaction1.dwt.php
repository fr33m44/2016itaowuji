...
<link href="<?php echo $this->_var['ectouch_themes']; ?>/ectouch.css?id=23" rel="stylesheet" type="text/css" />
...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
          ...
          <td width="68%" align="left"><?php echo $this->_var['order']['formated_total_fee']; ?></td>
        </tr>
        <tr>
...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1">
        <tr>
          <td align="left" bgcolor=""><a href="distribute.php?act=account_detail" class="f6">账户明细</a> | <a href="distribute.php?act=account_log" class="f6">提现记录</a></td>
        </tr>
      </table>
      <?php endif; ?> 
      ...
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
            ...
            <dl>
              ...
              <input name="real_name" type="text" placeholder="输入真实姓名" value="如：甜心100" class="dd2">
            </dl>
             <dl>
              <dd class="dd1">开户行 </dd>
			...
			<dl>
              <dd class="dd1">备注 </dd>
              <textarea placeholder="会员备注" name="user_note" class="B_blue" style="width:100%; height:70px; border:0px; font-size:1em;"></textarea>
            </dl> 
			</div>
        </section>
        <div class="blank3"></div>
         <div class="dd_btn">
              ...
              <input type="submit" name="submit"  class="c-btn"  value="<?php echo $this->_var['lang']['submit_request']; ?>"  style="border:none; margin-right:10px; width:40%; float:left;height: 20px" />
              <input type="reset" name="reset" class="c-btn" value="<?php echo $this->_var['lang']['button_reset']; ?>"  style="border:none; margin-right:10px; width:40%; background:#096; float:left;height: 20px"/>
        </div>
...
?>
        <tr>
          <td align="left" bgcolor="#ffffff" style="border:1px solid red;">【时间】<?php echo $this->_var['item']['change_time']; ?>【类型】<?php echo $this->_var['item']['type']; ?>【金额】<?php echo $this->_var['item']['amount']; ?>【备注】<?php echo $this->_var['item']['short_change_desc']; ?></td>
        </tr>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <tr>
...
3.建议将会员卡登陆密码与用户名登陆密码设为同一密码 有疑问联系QQ 356544984<br />
        </td>
        </tr>
        <tr>
