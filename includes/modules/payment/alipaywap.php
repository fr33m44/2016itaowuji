...
/**
 * iTaoWuJi 支付宝手机网站支付插件
 * 开发者：fr33m4n(微信)
 * ----------------------------------------------------------------------------
 * $Id: alipay.php 17217 2016-12-07 06:29:08Z $
 */
...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/alipaywap.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['config']  = array(
        ...
        array('name' => 'merchant_private_key',               'type' => 'textarea',   'value' => '')
    );
