 ...
 * @return  bool         $bool
 */
function register($username, $password, $email, $other = array(), $user_type, $storename, $storeaddress, $extendcode, $storestype)
{
    /* 检查注册是否关闭 */
    ...
    $newuserid = $GLOBALS['user']->add_user($username, $password, $email, $user_type, $storename, $storeaddress, $extendcode, $storestype);
    if (!$newuserid)
    {
